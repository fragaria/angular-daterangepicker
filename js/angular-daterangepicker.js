(function() {
  var gendaterangepicker, getdaterangepicker;

  getdaterangepicker = function(root, factory) {
    var jQuery;
    if (typeof define === 'function' && define.amd) {
      return define(['moment', 'jquery'], function(moment, jquery) {
        return root.daterangepicker = factory(moment, jquery);
      });
    } else if (typeof module === 'object' && module.exports) {
      jQuery = typeof window !== 'undefined' ? window.jQuery : void 0;
      if (!jQuery) {
  ...
  gendaterangepicker = function(moment, $) {
    var picker;
  ...
  getdaterangepicker(this, gendaterangepicker);
